...
| Denial of service | Huge fixture, event storm, callback panic, or native lifecycle leak exhausts memory or leaves capture wedged | Bounded parser, bounded callback batches/paths, panic containment, single-owner lifecycle, bounded pending queue, writer admission, input limits, bounded retries, visible loss | The task-0075 lifecycle corpus repeats private storm rows and reports callback/drop/resource distributions; sustained backpressure benchmarks remain future work |
