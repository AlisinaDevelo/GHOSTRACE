...
| Repudiation | An explanation hides a denied interval, restart, or replay conflict | First-class gaps, typed source identity, monotonic cursor state, event IDs, policy binding, deterministic output | Fixture cursor/replay/reset tests now; live recovery tests required |
