...
## Acceptance criteria
- [x] Golden cases cover every claim template, evidence level, gap interaction, and conflict outcome.
- [x] Property tests permute ingestion, equal timestamps, irrelevant events, and page boundaries without changing supported claims.
- [x] Mutation tests demonstrate that removing a required observation downgrades or removes the claim.
